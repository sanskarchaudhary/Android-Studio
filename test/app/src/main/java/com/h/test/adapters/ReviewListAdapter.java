...
import com.h.test.R;
import com.h.test.models.Review;
...
public class ReviewListAdapter extends RecyclerView.Adapter<ReviewListAdapter.ReviewListViewHolder> {
    ...
    public String timeAgo(Date currentDate, Date pastDate) {
        ...
        //Day or Days ago calculation
            ...
            return String.valueOf(Math.round(msExpired / milliSecPerDay)) + " yesterday";
        }
        //Month or Months ago calculation
        else if (msExpired < milliSecPerYear) {
            return String.valueOf(Math.round(msExpired / milliSecPerMonth)) + "  last month";
        }
        //Year or Years ago calculation
        else {
            return String.valueOf(Math.round(msExpired / milliSecPerYear)) + " last year";
        }
    }
}
