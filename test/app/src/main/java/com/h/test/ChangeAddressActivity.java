...
import com.h.test.models.UserAddress;
                ...
                try {
                    ...
                    try {
                        ...
                        if (httpsURLConnection.getResponseCode() == 200) {
                            ...
                            Toast.makeText(ChangeAddressActivity.this, "An error occurred", Toast.LENGTH_SHORT).show();
    ...
    public boolean validateData() {
        if (cbAddress2.isChecked())
            return etName1.getText().toString().equals("") || etPhone1.getText().toString().equals("") ||
                    ...
                    ctvCity1.getText().toString().equals("Select city / province") ||
                    ctvCity2.getText().toString().equals("Select city / province") ||
                    ctvDistrict1.getText().toString().equals("Select district") ||
                    ctvDistrict2.getText().toString().equals("Select district") ||
                    ctvTown1.getText().toString().equals("Select ward / commune") ||
                    ctvTown2.getText().toString().equals("Select ward / commune") ||
